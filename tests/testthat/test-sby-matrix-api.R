...
test_that("sby_adasyn_matrix increases only the minority class", {
  ...
  out <- sby_adasyn_matrix(x, y, sby_adasyn_ratio = 0.5, sby_seed = 11, sby_knn_engine = "FNN")
...
test_that("sby_nearmiss_index agrees with sby_nearmiss_matrix retained rows", {
  ...
  idx <- sby_nearmiss_index(x, y, sby_nearmiss_ratio = 0.5, sby_seed = 9, sby_knn_engine = "FNN")
  mat <- sby_nearmiss_matrix(x, y, sby_nearmiss_ratio = 0.5, sby_seed = 9, sby_knn_engine = "FNN", sby_return_index = TRUE)
...
test_that("tabular wrappers keep class distributions compatible with matrix API", {
  ...
  mat_ada <- sby_adasyn_matrix(x, y, sby_adasyn_ratio = 0.4, sby_seed = 4, sby_knn_engine = "FNN")
  tab_ada <- sby_adasyn(TARGET ~ ., dat, sby_adasyn_ratio = 0.4, sby_seed = 4, sby_knn_engine = "FNN")
  expect_equal(unname(table(tab_ada$TARGET)), unname(mat_ada$sby_output_class_distribution))

  mat_near <- sby_nearmiss_matrix(x, y, sby_nearmiss_ratio = 0.5, sby_seed = 5, sby_knn_engine = "FNN")
  tab_near <- sby_nearmiss(TARGET ~ ., dat, sby_nearmiss_ratio = 0.5, sby_seed = 5, sby_knn_engine = "FNN")
  expect_equal(unname(table(tab_near$TARGET)), unname(mat_near$sby_output_class_distribution))

  mat_adanear <- sby_adanear_matrix(x, y, sby_adasyn_ratio = 0.4, sby_nearmiss_ratio = 0.5, sby_seed = 6, sby_knn_engine = "FNN")
  tab_adanear <- sby_adanear(TARGET ~ ., dat, sby_adasyn_ratio = 0.4, sby_nearmiss_ratio = 0.5, sby_seed = 6, sby_knn_engine = "FNN")
...
test_that("tabular wrappers preserve original rows and restore only synthetic rows", {
  ...
  ada <- sby_adasyn(TARGET ~ ., dat, sby_adasyn_ratio = 0.5, sby_seed = 31, sby_knn_engine = "FNN")
  ...
  near_audit <- sby_nearmiss(TARGET ~ ., dat, sby_nearmiss_ratio = 0.5, sby_seed = 32, sby_knn_engine = "FNN", sby_audit = TRUE)
  expect_identical(
